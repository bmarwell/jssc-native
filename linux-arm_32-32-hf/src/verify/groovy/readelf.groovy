...
println '[INFO] Checking if built library [' + library.getAbsolutePath() + '] makes use of VFP registers.'
...
if (!containsVfpRegisters) {
  println '[ERROR] Library [' + library.getAbsolutePath() + '] does not make use of VFP registers.'
  throw new IllegalStateException("Library does not make use of VFP registers")
}
