...
println '[INFO] Checking if built library [' + library.getAbsolutePath() + '] is AArch64.'
...
def isAArch64 = stdOut.toString().contains("AArch64")

if (!isAArch64) {
  println '[ERROR] Library [' + library.getAbsolutePath() + '] is not AArch64.'
  throw new IllegalStateException("Library is not 'AArch64'!")
}
